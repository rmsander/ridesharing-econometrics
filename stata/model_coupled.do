...
ivregress 2sls excess_fuel_pop population pop_commuters free_travel arterial_street_travel time_value commercial_time_value avg_gas_cost avg_diesel_cost i.city_num i.year (sum_rideshare=unemp), robust

ivregress 2sls hrs_delay_pop population pop_commuters free_travel arterial_street_travel time_value commercial_time_value avg_gas_cost avg_diesel_cost i.city_num i.year (sum_rideshare=unemp), robust

// Two-Stage Least Squares - per capita variables
ivregress 2sls excess_fuel_per_cap population pop_commuters free_travel arterial_street_travel time_value commercial_time_value avg_gas_cost avg_diesel_cost i.city_num i.year (sum_rideshare=unemp), robust

ivregress 2sls hrs_delay_per_cap population pop_commuters free_travel arterial_street_travel time_value commercial_time_value avg_gas_cost avg_diesel_cost i.city_num i.year (sum_rideshare=unemp), robust

// Time Index Regression
ivregress 2sls travel_index population pop_commuters free_travel arterial_street_travel time_value commercial_time_value avg_gas_cost avg_diesel_cost i.city_num i.year (sum_rideshare=unemp), robust

// Congestion Cost Regression
ivregress 2sls congestion_cost_per_cap population pop_commuters free_travel arterial_street_travel time_value commercial_time_value avg_gas_cost avg_diesel_cost i.city_num i.year (sum_rideshare=unemp), robust
